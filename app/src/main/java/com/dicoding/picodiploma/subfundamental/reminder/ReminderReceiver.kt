package com.dicoding.picodiploma.subfundamental.reminder
...
import com.dicoding.picodiploma.subfundamental.view.SplashActivity
import java.util.*
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, message: String) {
        ...
        Log.e("Active Reminder", "")

        Toast.makeText(context, "Daily Reminder Have Been Active", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelReminder(context: Context) {
        ...
        Toast.makeText(context, "Repeating Reminder Have Been Canceled", Toast.LENGTH_SHORT).show()
    }
