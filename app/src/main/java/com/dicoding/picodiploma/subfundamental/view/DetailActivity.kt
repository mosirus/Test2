...
import com.dicoding.picodiploma.subfundamental.adapters.SectionPagerAdapter
import com.dicoding.picodiploma.subfundamental.databinding.ActivityDetailBinding
            ...
            if (it != null) {
                ...
                binding.apply {
                    ...
                    mainDetail.lottieGithub.setOnClickListener {
                        ...
                        Toast.makeText(this@DetailActivity, "You are currently opening the $name github link", Toast.LENGTH_SHORT).show()
                    ...
                    mainDetail.btnFavorite.setOnClickListener {
                        ...
                        if (isStateFav) {
                            ...
                            Toast.makeText(this@DetailActivity, "You Add $login To Favorite User", Toast.LENGTH_SHORT).show()
                        } else {
                            detailViewModel.deleteFromFav(id)
                            Toast.makeText(this@DetailActivity, "You Remove $login From Favorite User", Toast.LENGTH_SHORT).show()
                        }
                    ...
                    mainDetail.lottieShare.setOnClickListener {
                        ...
                        Toast.makeText(this@DetailActivity, "You share $name github link", Toast.LENGTH_SHORT).show()
                        Run.after(TIME_DELAY.toLong()) {
